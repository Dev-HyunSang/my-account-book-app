...
class IncomeSheet extends StatefulWidget {
  /// When provided, the sheet edits an existing income; otherwise it creates one.
  final IncomeItem? existing;
  final DateTime? initialDate;
  const IncomeSheet({super.key, this.existing, this.initialDate});
...
class _IncomeSheetState extends State<IncomeSheet> {
  ...
  void initState() {
    ...
    _date = e?.incomeDate ?? widget.initialDate ?? DateTime.now();
  }
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    const Icon(LucideIcons.arrowDownLeft, size: 20, color: TjColors.income),
                    const SizedBox(width: 8),
                    Text(_isEdit ? '수입 수정' : '수입 기록',
